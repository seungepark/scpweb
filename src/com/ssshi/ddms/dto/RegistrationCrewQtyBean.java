...
public class RegistrationCrewQtyBean {
	...
	public int getAnchorMealUid() {
		return anchorMealUid;
	}
	public void setAnchorMealUid(int anchorMealUid) {
	...
	public int getPlanMealQty() {
		return planMealQty;
	}
	public void setPlanMealQty(int planMealPlanQty) {
		this.planMealQty = planMealPlanQty;
	}
