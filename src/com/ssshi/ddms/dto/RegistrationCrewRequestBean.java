...
public class RegistrationCrewRequestBean {
	...
	private List<RegistrationCrewQtyBean> planList;
	private List<RegistrationCrewQtyBean> resultList;
	...
	public List<RegistrationCrewQtyBean> getPlanList() {
		return planList;
	}
	public void setPlanList(List<RegistrationCrewQtyBean> planList) {
		this.planList = planList;
	}
	public List<RegistrationCrewQtyBean> getResultList() {
		return resultList;
	}
	public void setResultList(List<RegistrationCrewQtyBean> resultList) {
