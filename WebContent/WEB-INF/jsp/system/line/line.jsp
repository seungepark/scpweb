...
<c:forEach var="at" items="${auth}">
	<c:if test="${at eq 'P_SYS_LINE'}">
		<c:set var="P_SYS_LINE" value="true" />
	</c:if>
	<c:if test="${at eq 'F_LINE_U'}">
		<c:set var="F_LINE_U" value="true"/>
	</c:if>
</c:forEach>
<c:if test="${empty P_SYS_LINE}">
...
<%-- 				<%@ include file="/WEB-INF/jsp/include/menu/bread_5_3.jsp"%> --%>
				<div class="row">
					<div class="col-xl-12 col-lg-12">
						<div class="page-title">
							<div class="x_content">
								<h3 class="g_text_primary font-weight-bold my-0" data-i18n="title">Approval</h3>
							</div>
						</div>
					</div>
				</div>
				<div class="row">
					<div class="col-12">
						<div class="x_panel">
							...
							<p class="clear-both ">
								<c:if test="${F_LINE_U}">
									<a href="${pageContext.request.contextPath}/system/line/modifyLine.html">
										<button type="button" class="btn btn-primary float-right">
											<img src="${pageContext.request.contextPath}/img/i_btn_modify.svg" class="mr-1" height="16px">
	...
	<script src="${pageContext.request.contextPath}/js/system/line.js"></script>
</body>
</html>
