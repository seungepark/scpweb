...
<%-- 				<%@ include file="/WEB-INF/jsp/include/menu/bread_5_1.jsp"%> --%>
				<div class="sec-option-card">
					<div class="row">
						...
						<div class="col">
							<div id="searchBtn">
								<button class="bt-obj bt-primary" onclick="getGroupList(1)">
				...
				<div class="tb-area">
					<div class="d-flex flex-row-reverse">
                   		<button class="bt-obj bt-primary" onClick="groupListDownloadAll()"><img src="${pageContext.request.contextPath}/img/i_download.svg" height="16px"></button>
                   		<c:if test="${P_SYS_GROUP_W}">
                   			<a href="${pageContext.request.contextPath}/system/group/newGroup.html">
							...
							<button class="bt-obj bt-danger-outline svg" onClick="popDeleteGroupModal()">
                    	...
                    	<table id="tbMainList" class="tb-style">
							<thead>
								<tr>
									...
									<th><div class="tb-th-col cursor-pointer tb-th-col-align" id="list0" onclick="tbAlign(this, 0)"><span class="tb-th-content" data-i18n="group"></span></div></th>
									<th><div class="tb-th-col cursor-pointer tb-th-col-align" id="list1" onclick="tbAlign(this, 1)"><span class="tb-th-content" data-i18n="desc"></span></div></th>
									<th><div class="tb-th-col-last cursor-pointer tb-th-col-align" id="list2" onclick="tbAlign(this, 2)"><span class="tb-th-content" data-i18n="status"></span></div></th>
								</tr>
							</thead>
							<tbody id="getGroupList">
								<tr><td class="text-center" colspan="4" data-i18n="share:noList"></tr>
							</tbody>
						</table>
                    </div>
                    <div class="sp-16"></div>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-body text-center pop-alert">
		        	...
		        	<button class="bt-obj bt-primary" onClick="deleteGroup()">
          				<img src="${pageContext.request.contextPath}/img/i_btn_del.svg" class="bt-icon" height="16px">
	...
	<script src="${pageContext.request.contextPath}/js/system/group.js"></script>
</body>
</html>
