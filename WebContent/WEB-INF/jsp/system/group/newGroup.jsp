...
<%-- 				<%@ include file="/WEB-INF/jsp/include/menu/bread_5_1.jsp"%> --%>
				<div class="sec-option-card">
					<div class="row">
						...
						<div class="col-auto">
							...
							<select id="authGroup" class=""></select>
						</div>
						<div class="col-auto">
				...
				<div class="sec-card">
					...
					<div class="d-flex flex-row-reverse">
						<button class="bt-obj bt-primary" onClick="insertGroup()">
  ...
  <div class="modal fade" id="add_modal" tabindex="-1" role="dialog" aria-labelledby="add_modal" aria-hidden="true">
	...
	<script src="${pageContext.request.contextPath}/js/system/new_group.js"></script>
</body>
</html>
