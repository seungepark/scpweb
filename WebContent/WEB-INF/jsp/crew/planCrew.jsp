...
<%--             	<%@ include file="/WEB-INF/jsp/include/menu/bread_1_2.jsp"%> --%>
            	<div class="tab-area">
                    ...
                    <div class="tab-base active"><a href="${pageContext.request.contextPath}/sche/planCrew.html?uid=${bean.uid}" data-i18n="tabCrew"></a></div>
				...
				<div class="tb-area">
					<div class="d-flex flex-row-reverse">
						<a href="${pageContext.request.contextPath}/mobile/mobileCrewinfo.html?uid=${bean.uid}" class="bt-obj bt-secondary mr-2" target="_blank">
							<i class="fas fa-mobile-alt"></i> 모바일 sdfsdf
						</a>
						<c:choose>
	...
	<script src="${pageContext.request.contextPath}/js/sche/planCrew.js"></script>
</body>
</html>
