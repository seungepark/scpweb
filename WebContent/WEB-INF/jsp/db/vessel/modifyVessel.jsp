...
<%-- 				<%@ include file="/WEB-INF/jsp/include/menu/bread_3_1.jsp"%> --%>
				<div class="sec-card">
					<div class="d-inline-block mr-3 w_30">
						...
						<input id="imo" type="text" class="w-100" value="${bean.imo}">
					</div>
					<div class="d-inline-block mr-3 w_30">
						<div class="lb-title" data-i18n="ship"></div>
						<input id="ship" type="text" class="w-100" value="${bean.shipNum}" disabled>
					</div>
					<div class="d-inline-block">
						<div class="lb-title" data-i18n="mmsi"></div>
						<input id="mmsi" type="text" class="w-100" value="${bean.mmsi}">
					</div>
					<div class="sp-16"></div>
					<div class="d-inline-block mr-3 w_30">
						<div class="lb-title" data-i18n="name"></div>
						<input id="name" type="text" class="w-100" value="${bean.title}">
					</div>
					<div class="d-inline-block w_30">
						...
						<select id="type">
							...
							<c:forEach var="shiptype" items="${listShip}">
								<option value="${shiptype.val}" <c:if test="${shiptype.description eq bean.shipType}">selected="selected" </c:if>>${shiptype.description}</option>
							</c:forEach>
						</select>
					</div>
					<div class="sp-16"></div>
					<div class="d-inline-block mr-3 w_30">
						...
						<input id="reg" type="text" class="w-100" value="${bean.regOwner}">
					</div>
					<div class="d-inline-block w_30">
						<div class="lb-title" data-i18n="year"></div>
						<input id="year" type="text" class="w-100" value="${bean.builtDate}">
					</div>
					<div class="sp-16"></div>
					<div class="d-inline-block mr-3 w_30">
						<div class="lb-title" data-i18n="flag"></div>
						<input id="flag" type="text" class="w-100" value="${bean.flag}">
					</div>
					<div class="sp-16"></div>
					<div class="d-inline-block mr-3 w_30">
						<div class="lb-title" data-i18n="gross"></div>
						<input id="gross" type="text" class="w-100" value="${bean.grossTon}">
					</div>
					<div class="d-inline-block w_30">
						<div class="lb-title" data-i18n="dwt"></div>
						<input id="dwt" type="text" class="w-100" value="${bean.dwt}">
					</div>
					<div class="sp-16"></div>
					<div class="d-inline-block mr-3 w_30">
						<div class="lb-title" data-i18n="loa"></div>
						<input id="loa" type="text" class="w-100" value="${bean.loa}">
					</div>
					<div class="d-inline-block w_30">
						<div class="lb-title" data-i18n="draught"></div>
						<input id="draught" type="text" class="w-100" value="${bean.draught}">
					</div>
					<div class="sp-16"></div>
					<div class="d-inline-block mr-3 w_30">
						<div class="lb-title" data-i18n="builder"></div>
						<input id="builder" type="text" class="w-100" value="${bean.builder}">
					</div>
					<div class="d-inline-block w_30">
						<div class="lb-title" data-i18n="built"></div>
						<input id="built" type="text" class="w-100" value="${bean.builtBy}">
					</div>
					<div class="sp-16"></div>
					<div class="d-flex flex-row-reverse">
						<button class="bt-obj bt-primary" onClick="updateVessel()">
	...
	<script src="${pageContext.request.contextPath}/js/db/vessel/modify_vessel.js"></script>
</body>
</html>
