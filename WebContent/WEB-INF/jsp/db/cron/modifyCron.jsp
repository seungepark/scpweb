...
<%-- 				<%@ include file="/WEB-INF/jsp/include/menu/bread_5_6.jsp"%> --%>
				<div class="sec-card">
					...
					<input id="cronid" type="text" class="w_30" value="${bean.cronid}" disabled>
					<div class="sp-16"></div>
					<div class="d-inline-block mr-3 w_30">
						<div class="lb-title" data-i18n="desc"></div>
						<input id="description" type="text" class="w-100" value="${bean.description}">
					</div>
					...
					<div class="d-inline-block mr-3 w_30">
						...
						<input id="frequency" type="text" class="w-100" value="${bean.frequency}">
					</div>
					<div class="d-inline-block w_30">
						<div class="lb-title" data-i18n="cronclass"></div>
						<input id="cronclass" type="text" class="w-100" value="${bean.cronclass}">
					</div>
					<div class="sp-16"></div>
					<div class="d-inline-block mr-3 w_30">
						<div class="lb-title" data-i18n="lastrundt"></div>
						<input id="lastrundate" type="text" class="w-100" value="${bean.lastrundate}" disabled>
					</div>
					<div class="d-inline-block w_30">
						<div class="lb-title" data-i18n="runcnt"></div>
						<input id="runcnt" type="text" class="w-100" value="${bean.runcnt}">
					</div>
					<div class="sp-16"></div>
					<div class="d-flex flex-row-reverse">
						<button class="bt-obj bt-primary" onClick="updateCron()">
	...
	<script src="${pageContext.request.contextPath}/js/db/cron/modify_cron.js"></script>
</body>
</html>
