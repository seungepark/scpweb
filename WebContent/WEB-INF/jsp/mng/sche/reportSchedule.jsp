...
<body>
	...
	<script src="${pageContext.request.contextPath}/js/mng/sche/ss_report_schedule.js"></script>
	<script src="${pageContext.request.contextPath}/js/mng/sche/report_schedule.js"></script>
