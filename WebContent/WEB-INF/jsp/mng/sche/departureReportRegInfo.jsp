...
<body class="nav-md">
					...
					<div class="col-12">
						<div class="x_content">
							<ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
								...
								<li class="nav-item">
									<a class="nav-link active" href="${pageContext.request.contextPath}/mng/sche/departureReportRegInfo.html?uid=${bean.uid}" role="tab" aria-selected="true"><span data-i18n="regInfo">Info Registration</span></a>
								</li>
								<li class="nav-item">
								...
								<table id="tbList"  data-toggle="table" data-custom-sort="tblistSort" class="table table-borderless table-striped jambo_table bulk_action mg-0">
									...
									<tbody>
										<tr class="even pointer">
											<td class="border text-center"><input id="commanderName" type="text" class="form-control" value="${commanderName}" data-index="${empty commanderNameuid ? 0 : commanderNameuid }"><input id="commanderTel" type="text" class="form-control" value="${commanderTel}" data-index="${empty commanderTeluid ? 0 : commanderTeluid }"></td>
											<td class="border text-center"><input id="subCommanderName" type="text" class="form-control" value="${subCommanderName}" data-index="${empty subCommanderNameuid ? 0 : subCommanderNameuid }"><input id="subCommanderTel" type="text" class="form-control" value="${subCommanderTel}" data-index="${empty subCommanderTeluid ? 0 : subCommanderTeluid }"></td>
											<td class="border text-center"><input id="masterName" type="text" class="form-control" value="${masterName}" data-index="${empty masterNameuid ? 0 : masterNameuid}"><input id="masterTel" type="text" class="form-control" value="${masterTel}" data-index="${empty masterTeluid ? 0 : masterTeluid}"></td>
											<td class="border text-center"><input id="pilotName" type="text" class="form-control" value="${pilotName}" data-index="${empty pilotNameuid ? 0 : pilotNameuid}"><input id="pilotTel" type="text" class="form-control" value="${pilotTel}" data-index="${empty pilotTeluid ? 0 : pilotTeluid}"></td>
											<td class="border text-center"><input id="admiralName" type="text" class="form-control" value="${admiralName}" data-index="${empty admiralNameuid ? 0 : admiralNameuid}"><input id="admiralTel" type="text" class="form-control" value="${admiralTel}" data-index="${empty admiralTeluid ? 0 : admiralTeluid}"></td>
											
											<td class="border text-center"><input id="designName" type="text" class="form-control" value="${designName}" data-index="${empty designNameuid ? 0 : designNameuid}"><input id="designTel" type="text" class="form-control" value="${designTel}" data-index="${empty designTeluid ? 0 : designTeluid}"></td>
											<td class="border text-center"><input id="qmName" type="text" class="form-control" value="${qmName}" data-index="${empty qmNameuid ? 0 : qmNameuid}"><input id="qmTel" type="text" class="form-control" value="${qmTel}" data-index="${empty qmTeluid ? 0 : qmTeluid}"></td>
										</tr>
										<tr class="even pointer">
										...
										<tr class="even pointer">
											<td colspan="7">
												<textarea style="width: 100%;" rows="3" cols="20" id="sbEtc" data-index="${empty sbEtcuid ? 0 : sbEtcuid}">${sbEtc}</textarea>
											</td>
										</tr>
									</tbody>
								</table>
									...
									<thead>
			                      	...
			                      	<tbody>
										<tr class="even pointer">
											...
											<td class="border text-center" ><input id="totalITP" type="number" step="1" class="form-control" value="${totalITP}" data-index="${empty totalITPuid ? 0 : totalITPuid}"></td>
											<td class="border text-center" ><input id="seaShedITP" type="number" step="1" class="form-control" value="${seaShedITP}" data-index="${empty seaShedITPuid ? 0 : seaShedITPuid}"></td>
											<td class="border text-center" ><input id="outFitITP" type="number" step="1" class="form-control" value="${outFitITP}" data-index="${empty outFitITPuid ? 0 : outFitITPuid}"></td>
										</tr>
										<tr class="even pointer">
											<td class="border text-center" >Punch<br>(Remain)</td>
											<td class="border text-center" ><input id="totalPunch" type="number" step="1" class="form-control" value="${totalPunch}" data-index="${empty totalPunchuid ? 0 : totalPunchuid}"></td>
											<td class="border text-center" ><input id="seaShedPunch" type="number" step="1" class="form-control" value="${seaShedPunch}" data-index="${empty seaShedPunchuid ? 0 : seaShedPunchuid}"></td>
											<td class="border text-center" ><input id="outFitPunch" type="number" step="1" class="form-control" value="${outFitPunch}" data-index="${empty outFitPunchuid ? 0 : outFitPunchuid}"></td>
										</tr>
									</tbody>
								</table>
								<br>
	...
	<script src="${pageContext.request.contextPath}/js/mng/sche/departureReport_regInfo.js"></script>
</body>
</html>
