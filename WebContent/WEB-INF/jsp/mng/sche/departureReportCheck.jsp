...
<body class="nav-md">
					...
					<div class="col-12">
						<div class="x_content">
							<ul class="nav nav-tabs bar_tabs" id="myTab" role="tablist">
								...
								<li class="nav-item">
									<a class="nav-link active" href="${pageContext.request.contextPath}/mng/sche/departureReportCheck.html?uid=${bean.uid}" role="tab" aria-selected="false"> &nbsp; <span data-i18n="depRpt">Departure Report</span> &nbsp;</a>
								</li>
							</ul>
						</div>
					</div>
					...
					<div class="col-12">
						<div class="x_panel">
							<div class="col-md-12 col-sm-12 pt-2">
								<button type="button" class="btn btn-primary float-right" onClick="submitReportInfo()">
							...
							<div class="col-md-12 col-sm-12 pt-2">
								<div class="departure_padding g_bg_light text-white text-center">
									<h2 data-i18n="list.title">${bean.hullnum} 해상 시운전 출항 보고</h2>
								...
								<div class="row">
									<div class="col-md-2 col-sm-12">
										<table data-toggle="table" data-custom-sort="tblistSort" class="table table-borderless table-striped jambo_table bulk_action mg-0">
											<thead>
												<tr class="headings">
													<th class="column-title border text-center">Schedule</th>
												</tr>
											</thead>
											<tbody>
												<tr class="even pointer">
													<td class="border text-center" ><span>${schedulerDaysText}<br>${schedulerHoursText} Hour</span></td>
												</tr>
											</tbody>
										</table>
									</div>
									<div class="col-md-10 col-sm-12">
										<div class="border">
											<span>2023년 47번째 시운전 출항 (총 50회 전망)</span><br>
											<span>${planText}</span><br>
											<span>[Coming Event]</span><br>
											<canvas id="titleCanvas" width="800px" height="62px"></canvas>
										</div>
									</div>
								</div>
								<div class="x_title border0">
									<h2 data-i18n="list.title">시운전 실적</h2>
								</div>
								<table data-toggle="table" data-custom-sort="tblistSort" class="table table-borderless table-striped jambo_table bulk_action mg-0">
									<thead>
										<tr class="headings">
											<th class="column-title border text-center"></th>
											<th class="column-title border text-center"><span data-i18n="list.commander">SN2307 전망</span></th>
											<th class="column-title border text-center"><span data-i18n="list.commander">SN2306</span></th>
											<th class="column-title border text-center"><span data-i18n="list.commander">SN2038</span></th>
											<th class="column-title border text-center"><span data-i18n="list.commander">시리즈평균</span></th>
										</tr>
									</thead>
									<tbody>
										<tr class="even pointer">
											<td class="border text-center" ><span data-i18n="list.commander">수행 시간</span></td>
											<td class="border text-center" ><input type="text" class="form-control" value="50" disabled></td>
											<td class="border text-center" ><input type="text" class="form-control" value="50" disabled></td>
											<td class="border text-center" ><input type="text" class="form-control" value="50" disabled></td>
											<td class="border text-center" ><input type="text" class="form-control" value="50" disabled></td>
										</tr>
										<tr class="even pointer">
											<td class="border text-center" ><span data-i18n="list.commander">HFO / MGO</span></td>
											<td class="border text-center" ><input type="text" class="form-control" value="60" disabled></td>
											<td class="border text-center" ><input type="text" class="form-control" value="30" disabled></td>
											<td class="border text-center" ><input type="text" class="form-control" value="10" disabled></td>
											<td class="border text-center" ><input type="text" class="form-control" value="70" disabled></td>
										</tr>
									</tbody>
								</table>
								<div class="x_title border0">
								...
								<table id="tbList"  data-toggle="table" data-custom-sort="tblistSort" class="table table-borderless table-striped jambo_table bulk_action mg-0">
									<thead>
									<tr class="headings">
										<th class="column-title border text-center" colspan="2"><span data-i18n="list.commander">Commander</span></th>
										<th class="column-title border text-center" ><span data-i18n="list.mach">기장운전</span></th>
										<th class="column-title border text-center" ><span data-i18n="list.hull">선장운전</span></th>
										<th class="column-title border text-center" ><span data-i18n="list.elec">전장운전</span></th>

										<th class="column-title border text-center" ><span data-i18n="list.depart">종합설계</span></th>
										<th class="column-title border text-center" ><span data-i18n="list.name">QM</span></th>
									</tr>
									</thead>
									<tbody>
									<tr class="even pointer">
										<td class="border text-center"><input id="commanderName" type="text" class="form-control" value="${commanderName}" data-index="${empty commanderNameuid ? 0 : commanderNameuid }" disabled><input id="commanderTel" type="text" class="form-control" value="${commanderTel}" data-index="${empty commanderTeluid ? 0 : commanderTeluid }" disabled></td>
										<td class="border text-center"><input id="subCommanderName" type="text" class="form-control" value="${subCommanderName}" data-index="${empty subCommanderNameuid ? 0 : subCommanderNameuid }" disabled><input id="subCommanderTel" type="text" class="form-control" value="${subCommanderTel}" data-index="${empty subCommanderTeluid ? 0 : subCommanderTeluid }" disabled></td>
										<td class="border text-center"><input id="masterName" type="text" class="form-control" value="${masterName}" data-index="${empty masterNameuid ? 0 : masterNameuid}" disabled><input id="masterTel" type="text" class="form-control" value="${masterTel}" data-index="${empty masterTeluid ? 0 : masterTeluid}" disabled></td>
										<td class="border text-center"><input id="pilotName" type="text" class="form-control" value="${pilotName}" data-index="${empty pilotNameuid ? 0 : pilotNameuid}" disabled><input id="pilotTel" type="text" class="form-control" value="${pilotTel}" data-index="${empty pilotTeluid ? 0 : pilotTeluid}" disabled></td>
										<td class="border text-center"><input id="admiralName" type="text" class="form-control" value="${admiralName}" data-index="${empty admiralNameuid ? 0 : admiralNameuid}" disabled><input id="admiralTel" type="text" class="form-control" value="${admiralTel}" data-index="${empty admiralTeluid ? 0 : admiralTeluid}" disabled></td>

										<td class="border text-center"><input id="designName" type="text" class="form-control" value="${designName}" data-index="${empty designNameuid ? 0 : designNameuid}" disabled><input id="designTel" type="text" class="form-control" value="${designTel}" data-index="${empty designTeluid ? 0 : designTeluid}" disabled></td>
										<td class="border text-center"><input id="qmName" type="text" class="form-control" value="${qmName}" data-index="${empty qmNameuid ? 0 : qmNameuid}" disabled><input id="qmTel" type="text" class="form-control" value="${qmTel}" data-index="${empty qmTeluid ? 0 : qmTeluid}" disabled></td>
									</tr>
									<tr class="even pointer">
										<td class="border text-center" ><img src="${pageContext.request.contextPath}/getProImgStream.html" class="img-circle profile_img"></td>
										<td class="border text-center" ><img src="${pageContext.request.contextPath}/getProImgStream.html" class="img-circle profile_img"></td>
										<td class="border text-center" ><img src="${pageContext.request.contextPath}/getProImgStream.html" class="img-circle profile_img"></td>
										<td class="border text-center" ><img src="${pageContext.request.contextPath}/getProImgStream.html" class="img-circle profile_img"></td>
										<td class="border text-center" ><img src="${pageContext.request.contextPath}/getProImgStream.html" class="img-circle profile_img"></td>
									...
									<tr class="even pointer">
										<td colspan="7">
											<textarea style="width: 100%;" rows="3" cols="20" id="sbEtc" data-index="${empty sbEtcuid ? 0 : sbEtcuid}" disabled>${sbEtc}</textarea>
										</td>
									</tr>
									</tbody>
								</table>
							...
							<div class="col-md-6 col-sm-12 pt-2">
								<div class="x_title border0">
									<h2 data-i18n="list.title">검사 / 펀치 현황</h2>
								</div>
								<table data-toggle="table" data-custom-sort="tblistSort2" class="table table-borderless table-striped jambo_table bulk_action mg-0">
									<thead>
									<tr class="headings">
										<th class="column-title border text-center"></th>
										<th class="column-title border text-center"><span data-i18n="list.commander">전체</span></th>
										<th class="column-title border text-center"><span data-i18n="list.commander">시운전</span></th>
										<th class="column-title border text-center"><span data-i18n="list.commander">의장</span></th>
									</tr>
									</thead>
									<tbody>
									<tr class="even pointer">
										<td class="border text-center">ITP</td>
										<td class="border text-center"><input id="totalITP" type="number" step="1" class="form-control" value="${totalITP}" data-index="${empty totalITPuid ? 0 : totalITPuid}" disabled></td>
										<td class="border text-center"><input id="seaShedITP" type="number" step="1" class="form-control" value="${seaShedITP}" data-index="${empty seaShedITPuid ? 0 : seaShedITPuid}" disabled></td>
										<td class="border text-center"><input id="outFitITP" type="number" step="1" class="form-control" value="${outFitITP}" data-index="${empty outFitITPuid ? 0 : outFitITPuid}" disabled></td>
									</tr>
									<tr class="even pointer">
										<td class="border text-center" >Punch<br>(Remain)</td>
										<td class="border text-center" ><input id="totalPunch" type="number" step="1" class="form-control" value="${totalPunch}" data-index="${empty totalPunchuid ? 0 : totalPunchuid}" disabled></td>
										<td class="border text-center" ><input id="seaShedPunch" type="number" step="1" class="form-control" value="${seaShedPunch}" data-index="${empty seaShedPunchuid ? 0 : seaShedPunchuid}" disabled></td>
										<td class="border text-center" ><input id="outFitPunch" type="number" step="1" class="form-control" value="${outFitPunch}" data-index="${empty outFitPunchuid ? 0 : outFitPunchuid}" disabled></td>
									</tr>
									</tbody>
								</table>
								<br>
								<br>
								<div class="x_title border0">
									<h2 data-i18n="list.title">시운전 항목</h2>
								</div>
								<table data-toggle="table" data-custom-sort="tblistSort2" class="table table-borderless table-striped jambo_table bulk_action mg-0">
									<thead>
									<tr class="headings">
										<th class="column-title border text-center" ><span data-i18n="list.commander">Sea Trial<br>Test</span></th>
									...
									<tbody>
									<tr class="even pointer">
										<td class="border text-center" ><input id="totalSeaTrialCnt" type="text" class="form-control" value="${totalSeaTrialCnt}" readonly></td>
										<td class="border text-center" ><input id="hullCnt" type="text" class="form-control" value="${hullCnt}" readonly></td>
										<td class="border text-center" ><input id="machineryCnt" type="text" class="form-control" value="${machineryCnt}" readonly></td>
										<td class="border text-center" ><input id="electricCnt" type="text" class="form-control" value="${electricCnt}" readonly></td>
									</tr>
									</tbody>
								</table>
							</div>
	...
	<script src="${pageContext.request.contextPath}/js/mng/sche/departureReport_check.js"></script>
</body>
</html>
