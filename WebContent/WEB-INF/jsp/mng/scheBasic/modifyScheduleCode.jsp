...
<%-- 				<%@ include file="/WEB-INF/jsp/include/menu/bread_3_4.jsp"%> --%>
				<div class="sec-option-card">
					<div class="row">
						<div class="col-md-3 col-sm-12">
							...
							<select id="shiptype" class="w-100" disabled>
								<option value=""  />
						...
						<div class="col-md-3 col-sm-12">
							...
							<select id="schedtype" class="w-100" disabled>
								<option value=""  />
					...
					<div class="row">
						...
						<div class="col-md-6 col-sm-12">
							...
							<input id="revnum" type="text" class="" value="${bean.revnum}" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\\..*)\\./g, '$1');">
						</div>
					</div>
				</div>
				<div class="sp-24"></div>
				<div class="tb-area">
					<div class="d-flex flex-row-reverse">
						...
						<a href="${pageContext.request.contextPath}/mng/scheBasic/detailScheduleCode.html?uid=${bean.uid}">
	...
	<script src="${pageContext.request.contextPath}/js/mng/scheBasic/modify_scheduleCode.js"></script>
</body>
</html>
