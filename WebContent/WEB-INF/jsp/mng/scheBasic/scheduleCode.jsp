...
<%-- 				<%@ include file="/WEB-INF/jsp/include/menu/bread_3_4.jsp"%> --%>
				<div class="sec-option-card">
					<div class="row">
						...
						<div class="col-auto">
							<div class="lb-title" data-i18n="listOp.schedtype"></div>
							<select id="schedtype" class="">
								<option value="ALL" data-i18n="listOp.typeAll"></option>
				...
				<div class="tb-area">
					<div class="d-flex flex-row-reverse">
                   		<c:if test="${P_DB_PJT_W}">
                   			<a href="${pageContext.request.contextPath}/mng/scheBasic/newScheduleCode.html">
						...
						<table id="tbList" class="tb-style">
							<thead>
		                    	<tr>
	                                ...
	                                <th><div class="tb-th-col cursor-pointer tb-th-col-align" id="list0" onclick="tbAlign(this, 0)"><span class="tb-th-content" data-i18n="list.shipType"></span></div></th>
	                                <th><div class="tb-th-col cursor-pointer tb-th-col-align" id="list1" onclick="tbAlign(this, 1)"><span class="tb-th-content" data-i18n="list.desc"></span></div></th>
	                                <th><div class="tb-th-col cursor-pointer tb-th-col-align" id="list2" onclick="tbAlign(this, 2)"><span class="tb-th-content" data-i18n="list.schedtype"></span></div></th>
	                                <th><div class="tb-th-col cursor-pointer tb-th-col-align" id="list3" onclick="tbAlign(this, 3)"><span class="tb-th-content" data-i18n="list.status"></span></div></th>
	                                <th><div class="tb-th-col-last cursor-pointer tb-th-col-align" id="list4" onclick="tbAlign(this, 4)"><span class="tb-th-content" data-i18n="list.revnum"></span></div></th>
	                            </tr>
		                  	</thead>
							<tbody id="scheduleCodelist">
								<tr>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="bt-obj bt-secondary" data-dismiss="modal" data-i18n="changePop.btnClose"></button>
					<button type="button" class="bt-obj bt-primary" onClick="changeStatus()" data-i18n="changePop.btnChange"></button>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="modal-content">
				<div class="modal-body text-center pop-alert">
		        	...
		        	<div class="pop-alert-msg" data-i18n="delPop.msg"></div>
          			<button type="button" class="bt-obj bt-secondary" data-dismiss="modal" data-i18n="delPop.btnClose"></button>
		        	<button type="button" class="bt-obj bt-primary" onClick="deleteSchedule()">
          				<img src="${pageContext.request.contextPath}/img/i_btn_del.svg" class="bt-icon" height="16px">
	...
	<script src="${pageContext.request.contextPath}/js/mng/scheBasic/scheduleCode.js"></script>
</body>
</html>