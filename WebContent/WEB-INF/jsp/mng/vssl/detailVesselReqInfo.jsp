...
<c:forEach var="at" items="${auth}">
	<c:if test="${at eq 'P_SHIP_INFO_R'}">
		<c:set var="P_SHIP_INFO_R" value="true" />
	</c:if>
	<c:if test="${at eq 'P_SHIP_INFO_W'}">
		<c:set var="P_SHIP_INFO_W" value="true" />
	</c:if>
</c:forEach>
<c:if test="${empty P_SHIP_INFO_R and empty P_SHIP_INFO_W}">
...
<%-- 				<%@ include file="/WEB-INF/jsp/include/menu/bread_1_4.jsp"%> --%>
				<div class="sec-option-card">
					<div class="row">
						<div class="col-md-3 col-sm-12 detail-label-border-b" data-i18n="hullNum"></div>
						<div class="col-md-3 col-sm-12 detail-content-border-b">${bean.hullNum}</div>
						<div class="col-md-3 col-sm-12 detail-label-border-b" data-i18n="desc"></div>
						<div class="col-md-3 col-sm-12 detail-content-border-b">${bean.description}</div>
					</div>
					<div class="row">
						<div class="col-md-3 col-sm-12 detail-label-border-b" data-i18n="shipType"></div>
						<div class="col-md-3 col-sm-12 detail-content-border-b">${bean.shiptype}</div>
					...
					<div class="row">
						<div class="col-md-3 col-sm-12 detail-label-border-b" data-i18n="registerdOwner"></div>
						<div class="col-md-3 col-sm-12 detail-content-border-b">${bean.registerdowner}</div>
						<div class="col-md-3 col-sm-12 detail-label-border-b" data-i18n="grossTonnage"></div>
						<div class="col-md-3 col-sm-12 detail-content-border-b">${bean.grosstonnage}</div>
					</div>
					<div class="row">
						<div class="col-md-3 col-sm-12 detail-label-border-b" data-i18n="drawn"></div>
						<div class="col-md-3 col-sm-12 detail-content-border-b">${bean.drawn}</div>
						<div class="col-md-3 col-sm-12 detail-label-border-b" data-i18n="checked"></div>
						<div class="col-md-3 col-sm-12 detail-content-border-b">${bean.checked}</div>
					</div>
					<div class="row">
						<div class="col-md-3 col-sm-12 detail-label-border-b" data-i18n="manager"></div>
						<div class="col-md-9 col-sm-12 detail-content-border-b">${bean.manager}</div>
					</div>
				</div>
				<div class="sp-24"></div>
				<div class="tb-area">
					<div class="d-flex flex-row-reverse">
               			...
               			<c:if test="${P_SHIP_INFO_W}">
	               			<a href="${pageContext.request.contextPath}/mng/vssl/modifyVesselReqInfo.html?uid=${bean.uid}">
						...
						<a href="${pageContext.request.contextPath}/mng/vssl/reqInfo.html">
							<button class="bt-obj bt-secondary svg">
                   	...
                   	<div class="sp-16"></div>
					<div class="tb-wrap scroll-area-reqinfo">
						<table id="tbRowVesselReqInfoDetailList" class="tb-style">
							<thead>
		                    	<tr>
	                                <th><div class="tb-th-col cursor-pointer tb-th-col-align" id="list0" onclick="tbAlign(this, 0)"><span class="tb-th-content" data-i18n="list.seq"></span></div></th>
	                                <th><div class="tb-th-col cursor-pointer tb-th-col-align" id="list1" onclick="tbAlign(this, 1)"><span class="tb-th-content" data-i18n="list.reqinfotitle"></span></div></th>
	                                <th><div class="tb-th-col cursor-pointer tb-th-col-align" id="list2" onclick="tbAlign(this, 2)"><span class="tb-th-content" data-i18n="list.item"></span></div></th>
	                                <th><div class="tb-th-col cursor-pointer tb-th-col-align" id="list3" onclick="tbAlign(this, 3)"><span class="tb-th-content" data-i18n="list.unit"></span></div></th>
	                                <th><div class="tb-th-col cursor-pointer tb-th-col-align" id="list4" onclick="tbAlign(this, 4)"><span class="tb-th-content" data-i18n="list.name"></span></div></th>
	                                <th><div class="tb-th-col cursor-pointer tb-th-col-align" id="list5" onclick="tbAlign(this, 5)"><span class="tb-th-content" data-i18n="list.rpm"></span></div></th>
	                                <th><div class="tb-th-col-last cursor-pointer tb-th-col-align" id="list6" onclick="tbAlign(this, 6)"><span class="tb-th-content" data-i18n="list.loadrate"></span></div></th>
	                            </tr>
		                  	</thead>
	...
	<script src="${pageContext.request.contextPath}/js/mng/vssl/detail_vesselReqInfo.js"></script>
</body>
</html>
