...
<%-- 				<%@ include file="/WEB-INF/jsp/include/menu/bread_1_4.jsp"%> --%>
				<div class="sec-option-card">
					<div class="row">
						...
						<div class="col">
							...
							<div id="searchBtn">
								<button class="bt-obj bt-primary" onclick="getVesselReqInfoList(1)">
				...
				<div class="tb-area">
					<div class="d-flex flex-row-reverse">
						<c:if test="${P_SHIP_INFO_W}">
							...
							<button class="bt-obj bt-danger-outline svg" onClick="popDeleteVesselReqInfoModal()">
						...
						<table id="tbList" class="tb-style">
							<thead>
		                    	<tr>
	                                ...
	                                <th><div class="tb-th-col cursor-pointer tb-th-col-align" id="list1" onclick="tbAlign(this, 1)"><span class="tb-th-content" data-i18n="list.shipType"></span></div></th>
	                                ...
	                                <th><div class="tb-th-col-last cursor-pointer tb-th-col-align" id="list4" onclick="tbAlign(this, 4)"><span class="tb-th-content" data-i18n="list.insertbyNm"></span></div></th>
	                            </tr>
		                  	</thead>
							<tbody id="vesselReqInfoList">
								<tr>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-body text-center pop-alert">
		        	...
		        	<button class="bt-obj bt-primary" onClick="deleteVesselReqInfo()">
          				<img src="${pageContext.request.contextPath}/img/i_btn_del.svg" class="bt-icon" height="16px">
	...
	<script src="${pageContext.request.contextPath}/js/mng/vssl/reqinfo.js"></script>
</body>
</html>