...
<%-- 				<%@ include file="/WEB-INF/jsp/include/menu/bread_1_4.jsp"%> --%>
				<div id="dParentData" class="sec-option-card">
					<div class="row">
						...
						<div class="col-md-6 col-sm-12">
							...
							<input id="desc" type="text" class="w-100" maxlength="150">
						</div>
						<div class="col-md-3 col-sm-12">
					...
					<div class="row">
						...
						<div class="col-md-3 col-sm-12">
							...
							<input id="registerdowner" type="text" class="w-100" maxlength="200">
						</div>
						<div class="col-md-3 col-sm-12">
							<div class="lb-title" data-i18n="grossTonnage"></div>
							<input id="grosstonnage" type="text" class="w-100" oninput="this.value = this.value.replace(/[^0-9.-]/g, '').replace(/(\..*)\./g, '$1').replace(/(\--*)\-/g, '$1');" maxlength="10">
						</div>
					</div>
					<div class="sp-16"></div>
					<div class="row">
						<div class="col-md-3 col-sm-12">
							...
							<input id="drawn" type="text" class="w-100" maxlength="200">
						</div>
						<div class="col-md-3 col-sm-12">
							<div class="lb-title" data-i18n="checked"></div>
							<input id="checked" type="text" class="w-100" maxlength="200">
						</div>
						<div class="col-md-3 col-sm-12">
							<div class="lb-title" data-i18n="manager"></div>
							<input id="managerIpt" type="text" class="w-100" maxlength="200">
						</div>
					</div>
				</div>
				<div class="sp-24"></div>
				<div class="tb-area">
					<div class="d-flex flex-row-reverse">
						<button class="bt-obj bt-primary" onClick="saveVesselReqInfo()">
                   	...
                   	<div class="sp-16"></div>
					<div class="tb-wrap scroll-area-vessel">
	...
	<script src="${pageContext.request.contextPath}/js/mng/vssl/new_vesselReqInfo.js"></script>
</body>
</html>
