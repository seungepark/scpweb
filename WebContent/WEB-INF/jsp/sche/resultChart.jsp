...
<%--             	<%@ include file="/WEB-INF/jsp/include/menu/bread_1_2.jsp"%> --%>
				<div class="tab-area">
                    <div class="tab-base active"><a href="${pageContext.request.contextPath}/sche/resultChart.html?uid=${bean.uid}" data-i18n="tabChart"></a></div>
...
<%-- 									<img src="${pageContext.request.contextPath}/img/new/date.png" class="bt-icon"> --%>
							...
							<div id="dDataPanel" style="display: none;">
								...
								<div class="tb-wrap scroll-area-chartlist">
									<table id="tbNewSchedulerList" class="tb-style">
										<thead>
											<tr>
												<th><div class="tb-th-col"><span class="tb-th-content"><input type="checkbox" id="scheRowAllChk" disabled></span></div></th>
												...
												<th><div class="tb-th-col"><span class="tb-th-content" data-i18n="list.pStartDate"></span></div></th>
												<th><div class="tb-th-col"><span class="tb-th-content" data-i18n="list.pStartTime"></span></div></th>
												<th><div class="tb-th-col"><span class="tb-th-content" data-i18n="list.pEndDate"></span></div></th>
												<th><div class="tb-th-col-last"><span class="tb-th-content" data-i18n="list.pEndTime"></span></div></th>
											</tr>
										</thead>
										<tbody id="getScheRowList">
											<tr>
												<td class="text-center" colspan="19" data-i18n="share:noList"></td>
											</tr>
										</tbody>
									</table>
								</div>
				...
				<div class="modal-body pop-main-scroll-container">
					...
					<table class="tb-style-view">
						...
						<tr class="d-none">
							...
							<td><input type="text" name="loadrate" class="" disabled/></td>
						</tr>
						<tr class="d-none">
							<td data-i18n="modal.dtype"></td>
							<td><input type="text" name="dtype" class="" disabled /></td>
							<td data-i18n="modal.seq"></td>
							<td><input type="text" name="seq" class="" oninput="this.value = this.value.replace(/[^0-9.-]/g, '').replace(/(\..*)\./g, '$1').replace(/(\--*)\-/g, '$1');" disabled/></td>
						</tr>
						<tr class="d-none">
						...
						<tr>
							<td data-i18n="modal.sdate"></td>
							<td colspan="2"><input id="sdateTimeTemp" type="datetime-local" name="sdateTimeTemp" class="" /></td>
							<td></td>
						</tr>
						<tr>
							<td data-i18n="modal.edate"></td>
							<td colspan="2"><input id="edateTimeTemp" type="datetime-local" name="edateTimeTemp" class="" /></td>
							<td></td>
						</tr>
						<tr>
							<td data-i18n="modal.ctypeLoadrate"></td>
							<td><div id="detailPopCtypeLoadrate" class="pl-3"></div></td>
							<td data-i18n="modal.perReadTm"></td>
							<td>
								<input type="text" name="per" class="pop-input-short text-center"/>
								<span id="detailPopReadTm"></span>
							</td>
						</tr>
						<tr class="d-none">
							...
							<td><input type="text" name="readytime" class="" disabled/></td>
						</tr>
					</table>
					<div class="sp-16"></div>
					<div class="text-center">
						<button id="detailPopBtnPlan" onclick="setTcDateTime('P')" class="bt-obj bt-primary" data-i18n="modal.btnPlan"></button>
						<button id="detailPopBtnResult" onclick="setTcDateTime('R')" class="bt-obj bt-secondary" data-i18n="modal.btnResult"></button>
					</div>
					<div class="d-none">
						<div class="pop-title d-flex align-items-center">
							...
							<div class="ml-auto">
								<button onclick="setPerformanceDate()" class="bt-obj bt-primary bt-sm">
									<img src="${pageContext.request.contextPath}/img/i_btn_save.svg" class="bt-icon" height="16px"><span data-i18n="modal.btnSync"></span>
								</button>
							</div>
						</div>
					</div>
					<table class="tb-style-view d-none">
						<colgroup>
							<col width="20%" />
							<col width="30%" />
							<col width="20%" />
					...
					<div class="sp-40"></div>
					<div class="pop-title" data-i18n="modal.noteTitle"></div>
					<div class="d-flex">
						<div class="flex-grow-1">
							<table class="tb-style">
								<tbody>
									<tr>
										<td data-i18n="modal.noteStart"></td>
										<td><input id="scheduleDetailModalNoteStartDate" onchange="setNoteTime()" type="datetime-local" name="performancesdate" class="" /></td>
									</tr>
									<tr>
										<td data-i18n="modal.noteEnd"></td>
										<td><input id="scheduleDetailModalNoteEndDate" onchange="setNoteTime()" type="datetime-local" name="performancesdate" class="" /></td>
									</tr>
								</tbody>
							</table>
						</div>
						<div class="sp-w-24"></div>
						<div class="align-self-center">
							<div class="border rounded-circle note-time-circle d-flex justify-content-center align-items-center">
								<span id="scheduleDetailModalNoteTime" class="note-time"></span>
								<span id="scheduleDetailModalNoteTimeMin" class="note-time-min"></span>
							</div>
						</div>
						<div class="sp-w-24"></div>
						<div class="align-self-center">
							<button class="bt-obj bt-primary" onClick="setNoteCodeList('U')"><i class="fa-solid fa-thumbs-up"></i></button>
							<button class="bt-obj bt-danger" onClick="setNoteCodeList('D')"><i class="fa-solid fa-thumbs-down"></i></button>
						</div>
					</div>
					<div class="sp-16"></div>
					<div class="pop-inner-title" data-i18n="modal.noteCode"></div>
					<select id="scheduleDetailModalNoteCodeList" class="w-100"></select>
					<div class="sp-16"></div>
					<div class="pop-inner-title" data-i18n="modal.noteTc"></div>
					<div id="scheduleDetailModalNoteTcList" class="note-tc-list-area inner-scroll-container"></div>
					<div class="sp-16"></div>
					<div class="pop-inner-title" data-i18n="modal.noteRemark"></div>
			    	<textarea id="scheduleDetailModalNoteRemark" class="w-100" rows="3"></textarea>
			    	<div class="sp-16"></div>
				  	<div>
				  		<div class="file-btn bt-obj bt-primary">
	                    	...
	                    	<span data-i18n="modal.noteBtnAddFile"></span>
	                    	<input id="addFile" onchange="fileAdded(this)" class="" type="file" accept="" multiple="multiple" multiple/>
	                  	</div>
				  	</div>
				  	<div class="sp-16"></div>
				  	<div id="scheduleDetailModalNoteFileList"></div>
				  	<div class="sp-16"></div>
				  	<div class="form-check align-middle text-right">
  						<input id="scheduleDetailModalNoteIsReport" type="checkbox" class="form-check-input">
  						<label for="scheduleDetailModalNoteIsReport" class="form-check-label" data-i18n="modal.noteIsReport"></label>
					</div>
				</div>
				<div class="modal-footer">
	...
	<script type="text/javascript">
	    ...
	    <c:forEach items="${listNoteUp}" var="item">
		    _noteUpList.push('${item.val}');
	    </c:forEach>
	
	    <c:forEach items="${listNoteDown}" var="item">
		    _noteDownList.push('${item.val}');
	    </c:forEach>
	</script>
	<!-- jQuery -->
	...
	<script src="${pageContext.request.contextPath}/js/sche/ssLineGanttChartResult.js"></script>
	<script src="${pageContext.request.contextPath}/js/sche/resultChart.js"></script>
