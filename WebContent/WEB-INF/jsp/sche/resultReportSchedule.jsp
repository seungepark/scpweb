...
<body>
	...
	<script src="${pageContext.request.contextPath}/js/sche/ssResultReportSchedule.js"></script>
	<script src="${pageContext.request.contextPath}/js/sche/resultReportSchedule.js"></script>
