...
<div class="sidebar-wrap">
	<div class="sidebar">
	   	...
	   	<c:if test="${M_P_GREEN_SCHE_R or M_P_GREEN_SCHE_W}">
	   		<div class="main-item active" data-toggle="collapse" data-target="#main-6-collapse" aria-expanded="true">
	        	<div class="main-item-icon-area">
				...
				<div class="main-item-title active" data-i18n="share:sidebar.main6.title"></div>
	   		</div>
	   		<div id="main-6-collapse" class="collapse show">
	   			...
	   			<a onclick="delSearchCookie()" href="${pageContext.request.contextPath}/sched/workStd/workStd.html">
       				<div class="sub-item-wrap sub-item-active">
		           		...
		           		<span class="sub-item-active-title" data-i18n="share:sidebar.main6.sub2"></span>
		       		</div>
       			</a>
   		...
   		<c:if test="${M_P_REG_CREW_R or M_P_REG_CREW_W}">
