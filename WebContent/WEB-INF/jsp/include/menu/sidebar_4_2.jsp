...
<div class="sidebar-wrap">
	<div class="sidebar">
	   	...
	   	<c:if test="${M_P_PLAN_SCHE_R or M_P_PLAN_SCHE_W or M_P_RESULT_SCHE_R or M_P_RESULT_SCHE_W}">
	   		<div class="main-item active" data-toggle="collapse" data-target="#main-4-collapse" aria-expanded="true">
	       		<div class="main-item-icon-area">
	       		...
	       		<div class="main-item-title active" data-i18n="share:sidebar.main4.title"></div>
	   		</div>
	   		<div id="main-4-collapse" class="collapse show">
   				<a onclick="delSearchCookie()" href="#">
	       		...
	       		<a onclick="delSearchCookie()" href="#">
	       			<div class="sub-item-wrap sub-item-active">
		           		...
		           		<span class="sub-item-active-title" data-i18n="share:sidebar.main4.sub2"></span>
		       		</div>
	       		</a>
	       		<a onclick="delSearchCookie()" href="#">
