							...
							if (!isRightButton) { // left click event
								...
								const mouseUpHandler = function (e) {
									...
									if (!moveTox && !moveToy) {
										...
										// DATA SETTING
										Object.keys(tl).forEach(k => {console.log(k);
											if ("codedetuid" === k) {
												// data-codeuid
										...
										// 250418 추가 //
										body.querySelector(`[name="detailSdateTime"]`).value = tl["sdate"] + 'T' + tl["stime"];
										body.querySelector(`[name="detailEdateTime"]`).value = tl["edate"] + 'T' + tl["etime"];
										//-- 250418 --//
										...
										modal.querySelector(".save").onclick = () => {
											...
											let edateTime = $('#detailEdateTime').val().split('T');
