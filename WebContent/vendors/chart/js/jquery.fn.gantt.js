    ...
    $.fn.gantt = function (options) {
        ...
        var core = {
            ...
            rightPanel: function (element, leftPanel /* <- never used? */) {
                ...
                // reused variables
                var $row = $('<div class="grow header"></div>');
                var i, len;
                ...
                case "hours":
                    ...
                    for (i = 0, len = range.length; i < len; i++) {
                        ...
                        if (rfy !== year) {
                            yearArr.push(
                                '<div class="grow year" style="width: ' +
                        ...
                        if (rm !== month) {
                            monthArr.push(
                                '<div class="grow month" style="width: ' +
                ...
                case 'months':
                    ...
                    for (i = 0, len = range.length; i < len; i++) {
                        ...
                        scaleUnitsThisYear++;
                        monthArr.push(
                            '<div class="grow day wd" id="dh-' + tools.genId(rday) +
                            '" data-offset="' + i * tools.getCellSize() +
                            '" data-repdate="' + rday.getRepDate(settings.scale) + '">' +
                            (1 + rday.getMonth()) + '</div>');
                    }
            ...
            navigation: function (element) {
                    ...
                    ganttNavigate = $('<div class="navigate" />')
                        .append($('<div class="nav-slider" />')
                            .append($('<div class="nav-slider-left" />')
                                .append($('<button type="button" class="gnav-link nav-page-back"/>')
                                    .html('&uarr;')
                                    .click(function () {
                                ...
                                .append($('<button type="button" class="gnav-link nav-page-next"/>')
                                    .html('&darr;')
                                    .click(function () {
                                        core.navigatePage(element, 1);
                                    }))
                                .append($('<button type="button" class="gnav-link nav-now"/>')
                                    .html('&#9679;')
                                    .click(function () {
                                        core.navigateTo(element, 'now');
                                    }))
                                .append($('<button type="button" class="gnav-link nav-prev-week"/>')
                                    .html('&lt;&lt;')
                                    .click(function () {
                                ...
                                .append($('<button type="button" class="gnav-link nav-prev-day"/>')
                                    .html('&lt;')
                                    .click(function () {
                                        if (settings.scale === 'hours') {
                            ...
                            .append($('<div class="nav-slider-right" />')
                                .append($('<button type="button" class="gnav-link nav-next-day"/>')
                                    .html('&gt;')
                                    .click(function () {
                                        if (settings.scale === 'hours') {
                                            core.navigateTo(element, tools.getCellSize() * -4);
                            ...
                            .append($('<button type="button" class="gnav-link nav-next-week"/>')
                                    .html('&gt;&gt;')
                                    .click(function () {
                                        if (settings.scale === 'hours') {
                                            core.navigateTo(element, tools.getCellSize() * -8);
                                ...
                                .append($('<button type="button" class="gnav-link nav-zoomIn"/>')
                                    .html('&#43;')
                                    .click(function () {
                                        core.zoomInOut(element, -1);
                                    }))
                                .append($('<button type="button" class="gnav-link nav-zoomOut"/>')
                                    .html('&#45;')
                                    .click(function () {
                                        core.zoomInOut(element, 1);
                                    }))
                ...
                // Button navigation is provided by setting `settings.navigation='buttons'`
                    ...
                    ganttNavigate = $('<div class="navigate" />')
                        ...
                        .append($('<button type="button" class="gnav-link nav-begin"/>')
                            .html('&#124;&lt;')
                            .click(function () {
                        ...
                        .append($('<button type="button" class="gnav-link nav-end"/>')
                            .html('&gt;&#124;')
                            .click(function () {
        ...
        var tools = {
            ...
            getCellSize: function () {
                if (typeof tools._getCellSize === "undefined") {
                    var measure = $('<div style="display: none; position: absolute;" class="fn-gantt"><div class="grow"></div></div>');
                    $("body").append(measure);
                    tools._getCellSize = measure.find(".grow").height();
